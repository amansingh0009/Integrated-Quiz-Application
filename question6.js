let questions = [
    ...
    {
        numb: 10,
        question: "Python supports the creation of anonymous functions at runtime, using a construct called ___?",
        answer: "C. lambda",
        options: [
            "A. pi",
            "B. anonymous",
            "C. lambda",
            "D. none of the mentoined"
        ]
    },
    {
        numb: 11,
        question: "What is the order of precedence in python?",
        answer: "D. Parentheses, Exponential, Multiplication, Division, Addition, Subtraction",
        options: [
    ...
    },
    {
        ...
        answer: "B. A folder of python modules",
        options: [
    ...
    },
    {
        ...
        answer: "C. Python first searches the local namespace, then the global namespace and finally the built-in namespace",
        options: [
